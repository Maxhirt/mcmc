...
// -I$ARMA_INCLUDE_PATH -I./../../include/ rmhmc_normal.cpp -o rmhmc_normal.out
// -L./../.. -lmcmc
...
arma::mat tensor_fn(const arma::vec &vals_inp, mcmc::Cube_t *tensor_deriv_out,
                    void *tensor_data) {
  // const double mu    = vals_inp(0);
  const double sigma = vals_inp(1);
...
double log_target_dens(const arma::vec &vals_inp, arma::vec *grad_out,
                       void *ll_data) {
