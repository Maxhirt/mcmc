...
//     // return Eigen::VectorXd{ nr }.unaryExpr([&](double x) { (void)(x);
//     return dist(gen); }); return ColVec_t{ nr }.unaryExpr([&](double x) {
//     (void)(x); return dist(gen); });
// }
...
//     // return Eigen::MatrixXd{ nr, nc }.unaryExpr([&](double x) { (void)(x);
//     return dist(gen); }); return Mat_t{ nr, nc }.unaryExpr([&](double x) {
//     (void)(x); return dist(gen); });
// }
